...
curl -XDELETE 'http://elastic:changeme@localhost:9200/logstash-2015.05.18'
curl -XPUT 'http://elastic:changeme@localhost:9200/logstash-2015.05.18' -d '
{
  "mappings": {
    "log": {
      "properties": {
...
curl -XDELETE 'http://elastic:changeme@localhost:9200/logstash-2015.05.19'
curl -XPUT 'http://elastic:changeme@localhost:9200/logstash-2015.05.19' -d '
{
  "mappings": {
    "log": {
      "properties": {
